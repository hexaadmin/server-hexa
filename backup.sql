...
-- Dumping data for table roleplay.addon_account: ~25 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `addon_account_data` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=18337 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;

-- Dumping data for table roleplay.addon_account_data: ~67 rows (approximately)
...
-- Dumping data for table roleplay.addon_inventory: ~26 rows (approximately)
...
-- Dumping data for table roleplay.addon_inventory_items: ~12 rows (approximately)
...
REPLACE INTO `datastore_data` (`id`, `name`, `owner`, `data`) VALUES
	...
	(57, 'housing', '54f6145a9c929927df2822e3dff5193409d8d6c1', '{}'),
...
CREATE TABLE IF NOT EXISTS `items` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=687 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin ROW_FORMAT=DYNAMIC;

-- Dumping data for table roleplay.items: ~166 rows (approximately)
...
-- Dumping data for table roleplay.job_grades: ~105 rows (approximately)
...
REPLACE INTO `job_grades` (`id`, `job_name`, `grade`, `name`, `label`, `salary`, `skin_male`, `skin_female`) VALUES
	...
	(199, 'police', 2, 'officer1', 'Officer |', 8000, '{}', '{}'),
	(200, 'police', 3, 'officer2', 'Officer ||', 11000, '{}', '{}'),
	(201, 'police', 4, 'officer3', 'Officer |||', 14000, '{}', '{}'),
...
-- Dumping data for table roleplay.owned_bags: ~5 rows (approximately)
...
REPLACE INTO `owned_bags` (`identifier`, `id`, `x`, `y`, `z`, `itemcount`) VALUES
	...
	('54f6145a9c929927df2822e3dff5193409d8d6c1', 56168, NULL, NULL, NULL, 0);
...
-- Dumping data for table roleplay.owned_vehicles: ~6 rows (approximately)
...
-- Dumping data for table roleplay.phone_messages: 18 rows
...
REPLACE INTO `shops` (`id`, `store`, `item`, `price`) VALUES
	...
	(76, 'Clinic', 'medikit', 10),
	(77, 'Clinic', 'bandage', 85),
	(78, 'bar', 'donut', 30),
...
-- Dumping data for table roleplay.trunk_inventory: ~3 rows (approximately)
